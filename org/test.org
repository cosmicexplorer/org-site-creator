...
* The Name of the Game
  ...
  It is used on the org-mode site to display =ORGWEBPAGE/Changes.org= which
...
** <<<Download>>>
   ...
   - A list of changes can be found here (separate file).
   - Download the minified version or the source code.
   - Create the minified versions from the sources using the Makefile and a
     little sed script.
